...
Available from the [openSUSE Build Service](https://build.opensuse.org/package/show/home:guy-marc.aprin/lsgpus).
...
sudo zypper refresh
sudo zypper install lsgpus
```

The same repository also ships `lsdisplay` (the companion display-listing tool). Updates
